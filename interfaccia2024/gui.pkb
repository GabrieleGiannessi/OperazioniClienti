...
BEGIN
    ...
    htp.prn('</td>');
    htp.prn('<script>');
    htp.prn('document.querySelector("button").addEventListener("click", function() {');
...
BEGIN
	...
	htp.prn('</td>');
	htp.prn('<script>');
    htp.prn('document.querySelector("a").addEventListener("click", function() {');
    htp.prn('document.getElementById("inputModifica").setAttribute("name", "Modifica");');
    htp.prn('});');
    htp.prn('</script>');
